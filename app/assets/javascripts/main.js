    ...
    var pieChartOne = new JSChart('qbdxPieChart', 'pie');
    ...
    var pieChartTwo = new JSChart('mediaPieChart', 'pie');
    ...
    var barChart = new JSChart('top10Chart', 'bar');
